...
export const Dropdown = ({ dropdownTitle, dropdownActiveDescription }) => {
    ...
    return (
        <div className="dropdown">
            ...
            <p className={`dropdown__content${isOpen ? ' dropdown__content-active' : ''}`}>{dropdownActiveDescription}</p>
        </div>
    );
};

export const DropdownList = ({ dropdownTitle, dropdownActiveDescription }) => {
    const [isOpen, setIsOpen] = useState(false);
    ...
    return (
        <div className="dropdown">
            ...
            <ul className={`dropdown__content${isOpen ? ' dropdown__content-active' : ''}`}>
                {dropdownActiveDescription.map((description, index) => (
